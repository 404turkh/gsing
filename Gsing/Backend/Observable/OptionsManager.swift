...
struct Options: Codable, Equatable {
	...
	/// If Gsing should remove the app after signed it in the Downloaded Apps options
    var removeApp: Bool
    /// If Gsing should only modify and no signing
    var onlyModify: Bool
	/// If Gsing copy things should start in the last used location instead of Documents dir
	var useLastExportLocation: Bool?
	/// If Gsing should use Zip or ZIPFoundation
    ...
    /// If Gsing should use background audio
    var backgroundAudio: Bool
    /// If Gsing should show logs when signing
    var signingLogs: Bool
    /// If Gsing should notify when download is completed
