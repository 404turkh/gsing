...
struct FileRow: View {
    ...
    private func fileConfirmationDialogButtons() -> some View {
        ...
        if file.isGsingFile {
            Button {
                UIAlertController.showAlertWithOk(title: "?", message: .localized("Gsing certificate file (.gsing) is now unsupported from v1.5.1, please refer to use .p12 and .mobileprovision instead."))
            } label: {
